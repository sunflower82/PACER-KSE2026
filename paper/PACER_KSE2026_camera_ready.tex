...
%%        Multimodal Recommendation --- KSE 2026 (v35, camera-ready)
...
\usepackage{cite}
\usepackage{url}
\urldef{\pacergithub}\url{https://github.com/sunflower82/PACER-KSE2026}
\usepackage{xspace}
...
Code, configuration files, and manuscript source:
\pacergithub.
The Amazon Clothing and Sports 5-core splits and the frozen
ResNet-50 / Sentence-BERT features are the public release
accompanying MMHCL~\cite{guo2025mmhcl}, consumed unmodified;
